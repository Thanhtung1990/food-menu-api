...
public class Encrypted_Any_Text {

//private CqlSession session;
    //private static final Logger log = LoggerFactory.getLogger(UpdatableBCrypt.class);

    private int logRounds = 15;

    //constructor
    //public Encrypted_Any_Text(int logRounds) {
    //    this.logRounds = logRounds;
    //}

    public String hashAnyText(String password) {
    ...
    public boolean verifyAndUpdateHash(String password, String hash, Function<String, Boolean> updateFunc) {
        if (BCrypt.checkpw(password, hash)) {
            ...
            if (rounds != logRounds) {
                ...
                String newHash = hashAnyText(password);
